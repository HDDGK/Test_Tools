...
class mainwindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.comboBox.setObjectName("styleBox")
        tmp_layout.addWidget(self.comboBox)
        self.comboBox.addItem("极致色彩")
        self.comboBox.addItem("漫画风格")
    ...
    def show_image(self):
        ...
        if fname is not None and fname != "":
            ...
            pc.pictureSavePath("Fix")
            pc.CheckPath()
            im.save(pc.pictureSavePath("Fix"))
            '''
            ...
            # print(img)
            '''
            fix_img=QImageReader(pc.pictureSavePath("Pic_HeavyColor"))
            # print(img2)
