...
class ImageEditToolWindow(object):
    ...
    def creatImageEditTab(self):
        ...
        #为了给布局上滚动条，先上一个横向布局，把原有布局嵌套进去，然后加个bar看看效果
        self.tab_1lLayout = QtWidgets.QHBoxLayout(self.tab)
        self.tab_1lLayout.setObjectName("tab_1_verticalLayout")

        # 先给Tab上个布局
        self.tab_1_verticalLayout = QtWidgets.QVBoxLayout(self.tab)
        self.tab_1_verticalLayout.setObjectName("tab_1_verticalLayout")
        self.tab_1lLayout.addLayout(self.tab_1_verticalLayout)
        # 创建一个滚动条
        self.verticalScrollBar = QtWidgets.QScrollBar(self.tab)
        self.verticalScrollBar.setOrientation(QtCore.Qt.Vertical)
        self.verticalScrollBar.setObjectName("verticalScrollBar")
        self.tab_1lLayout.addWidget(self.verticalScrollBar)
