...
f1rect=f1.render_to(screen,pos,"世界核平",fgcolor=GREEN,size=50)
...
while True:
    ...
    #     speed[1]=-speed[1]
    #     if ballrect.bottom>height and ballrect.bottom+speed[1]>ballrect.bottom<0:
    #         speed[1]=-speed[1]
    ...
    bgcolor.b=RGBChannel(min(speed[0],speed[1])*255/max(speed[0],speed[1]))
    fgcolor.r=255-bgcolor.r
    fgcolor.g=255-bgcolor.g
    fgcolor.b=255-bgcolor.b

    screen.fill(bgcolor)
    f1rect=f1.render_to(screen,pos,"世界和平",fgcolor=fgcolor,size=50)
